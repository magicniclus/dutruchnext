            ...
            <div className='w-full flex justify-between font-bebas md:flex-row flex-col'>
                <div className='bg-white p-7 md:w-[48%] w-full'>
                    ...
                    <ul className="mt-10 font-cormorant text-[19px]">
                        ...
                        <li ref={lignTextRefThree} className='flex mt-1'><span className="mr-2 min-w-4 h-0.5 bg-red mt-3 "></span><span className='text-red mr-3'>1932</span>Classement Cru Bourgeois Supérieur.</li>
                        <li ref={lignTextRefFour} className='flex mt-1'><span className="mr-2 min-w-4 h-0.5 bg-red mt-3 "></span><span className='text-red mr-3'>1966</span>Classement Cru Bourgeois Exceptionnel.</li>
                        ...
                        <li ref={lignTextRefSix} className='flex mt-1'><span className="mr-2 min-w-4 h-0.5 bg-red mt-3 "></span><span className='text-red mr-3'>1978</span>Classement Cru Bourgeois Exceptionnel.</li>
    ...
    const textAng = () => {
        return(
            <div className='w-full flex justify-between font-bebas md:flex-row flex-col'>
                ...
                <div className='bg-white p-7 md:w-[48%] w-full md:mt-0 mt-5'>
                    <h2 className='uppercase text-red font-bebas  text-[36px] md:h-[45px] ' ref={titleRefTwo}>PRESERVING THE ENVIRONMENT</h2>
