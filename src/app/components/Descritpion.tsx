        ...
        return(
            <div className='w-full flex justify-between font-bebas md:flex-row flex-col'>
                <div className='bg-white p-7 md:w-[48%] w-full'>
                    <h2 className='uppercase text-red font-bebas text-3xl ' ref={titleRef}>Château dutruch grand poujeaux</h2>
                    <h3 className='uppercase font-bebas text-xl text-text ' ref={subtitleRef}>de famille en famille</h3>
                    <div className='overflow-hidden'>
                        <div className="w-[84px] h-0.5 bg-red mt-4" ref={lignRef}></div>
                    </div>
                    <ul className="mt-10 font-cormorant">
                        <li ref={lignTextRef} className='flex'><span className="mr-2 w-4 h-0.5 bg-red mt-3 "></span><span className='text-red mr-3'>XIXe</span>Création de la propriété par la famille Dutruch.</li>
                        <li ref={lignTextRefTwo} className='flex mt-1'><span className="mr-2 w-4 h-0.5 bg-red mt-3 "></span><span className='text-red mr-3'>1868</span>Premières traces du Château Dutruch Grand Poujeaux dans le guide Féret. </li>
                        <li ref={lignTextRefThree} className='flex mt-1'><span className="mr-2 w-4 h-0.5 bg-red mt-3 "></span><span className='text-red mr-3'>1932</span>Classement au Cru Bourgeois Supérieur.</li>
                        <li ref={lignTextRefFour} className='flex mt-1'><span className="mr-2 w-4 h-0.5 bg-red mt-3 "></span><span className='text-red mr-3'>1966</span>Classement au Cru Bourgeois Exceptionnel.</li>
                        <li ref={lignTextRefFive} className='flex mt-1'><span className="mr-2 w-4 h-0.5 bg-red mt-3 "></span><span className='text-red mr-3'>1967</span>François Cordonnier (senior), ancien régisseur du Château de Chenonceau dans la Loire, achète la propriété propriété et porte le vignoble de 11 à 28 ha.</li>
                        <li ref={lignTextRefSix} className='flex mt-1'><span className="mr-2 w-4 h-0.5 bg-red mt-3 "></span><span className='text-red mr-3'>1978</span>Classement au Cru Bourgeois Exceptionnel.</li>
                        <li ref={lignTextRefSeven} className='flex mt-1'><span className="mr-2 w-4 h-0.5 bg-red mt-3 "></span><span className='text-red mr-3'>1994</span>Sans enfant, il transmet la propriété à son neveu Jean-Baptiste.</li>
                        <li ref={lignTextRefEight} className='flex mt-1'><span className="mr-2 w-4 h-0.5 bg-red mt-3 "></span><span className='text-red mr-3'>2016</span>François Cordonnier (Junior) reprend le flambeau pour continuer le travail entamé par son oncle dans la recherche perpétuelle de qualité.</li>
                        <li ref={lignTextRefNine} className='flex mt-1'><span className="mr-2 w-4 h-0.5 bg-red mt-3 "></span><span className='text-red mr-3'>2018</span>Première parcelle en agriculture biologique et certification Haute Valeur Environnementale</li>
                    </ul>
                </div>
                <div className='bg-white p-7 md:w-[48%] w-full md:mt-0 mt-5'>
                    <h2 className='uppercase text-red font-bebas text-3xl ' ref={titleRefTwo}>Préserver l’environnement</h2>
                    <h3 className='uppercase font-bebas text-xl text-text ' ref={subtitleRefTwo}>Pour atteindre l’excellence</h3>
                    <div className='overflow-hidden'>
                        <div className="w-[84px] h-0.5 bg-red mt-4" ref={lignRefTwo}></div>
                    </div>
                    <p className='mt-10 font-cormorant ' ref={paraphRef}>
