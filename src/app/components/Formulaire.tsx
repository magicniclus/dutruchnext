  ...
  const handleForm = () => {
    if (lang === "fr") {
      if (isSubmitted) {
        return (
          <section
            className="mx-auto flex flex-col md:max-w-5xl md:px-4 w-full"
            id="form"
            ref={formRef}
          >
            <div className="bg-beige w-full md:translate md:-translate-y-16 p-16">
              <div className="w-full flex justify-center items-center flex-col">
                <h2 className="text-red font-bebas text-3xl">
      ...
      return (
        <section
          className="mx-auto flex flex-col md:max-w-7xl md:px-4 w-full"
          id="form"
        >
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="flex md:flex-row flex-col">
                  <div className="flex md:w-[40%] justify-between md:flex-row flex-col">
                    <div className="flex flex-col md:mt-0">
                      <label
                        className="font-cormorant ml-2 text-text"
                        htmlFor="name"
                      >
                        Prénom*
                      </label>
                      <input
                        ...
                        id="name"
                        placeholder="JHON"
                        className="text-sm p-2 text-source rounded-sm"
                ...
                <div className="flex md:flex-row flex-col">
                  <div className="flex md:w-[40%]">
                    <div className="flex flex-col w-full">
                      <label className="font-cormorant ml-2" htmlFor="email">
                        Email*
                      </label>
                      <input
                        type="text"
                        ...
                        className="text-sm w-full p-2 text-source rounded-sm"
                  ...
                  <div className="flex md:w-[40%] md:ml-10 md:flex-row flex-col">
                    <div className="flex flex-col md:mt-0 mt-3">
                      ...
                      <input
                        ...
                        className="text-sm p-2 text-source rounded-sm md:max-w-[140px]"
                ...
                <div className="flex w-full">
                  <div className="flex flex-col w-full">
                    <label
                      ...
                      htmlFor="email"
                    >
                      Précisez votre demande pour être recontacté*
                    </label>
                    <input
                      type="text"
                      name="text"
              ...
              <div className="mt-5 text-text text-sm flex justify-between md:flex-row flex-col">
                <div className="md:w-1/2 border-none">
                  ...
                  />
                  <label
                    className="font-cormorant text-text"
                    htmlFor="checkbox"
                  >
                    J’accepte que mes données personnelles soient collectées
                    afin que Château Dutruch Grand Poujeaux puisse me
                    recontacter.
                  </label>
                </div>
                <div className="md:w-[220px] flex md:items-end text-text justify-between md:flex-row flex-col md:mt-0 mt-5">
                  <p className="text-xs font-cormorant md:mb-0 mb-2">
                    *Champs obligatoires
                  </p>
                  <button
                    disabled={!isValid}
                    type="submit"
                    className={`justify-center flex bg-red px-5 py-2 rounded-full items-center cursor-pointer transition duration-300 ease-in-out ${
                      !isValid
                        ? "opacity-50"
                ...
                <div className="flex w-full">
                  <div className="flex flex-col w-full">
                    <label
                      ...
                      htmlFor="email"
                    >
                      Specify your request to be contacted*
                    </label>
                    <input
                      type="text"
                      name="text"
              ...
              <div className="mt-5 text-text text-sm flex justify-between md:flex-row flex-col">
                <div className="md:w-1/2 border-none">
                  ...
                  <label
                    ...
                    htmlFor="checkbox"
                  >
                    I accept that my personal data will be collected so that
                    Château Dutruch Grand Poujeaux can contact me again.
                  </label>
                </div>
                <div className="md:w-[220px] flex md:items-end text-text justify-between md:flex-row flex-col md:mt-0 mt-5">
                  <p className="text-xs font-cormorant md:mb-0 mb-2">
